...
Expected output:
    All 54 pairs: error < 1e-15 (machine precision)
...
print('PASSED: all kinematic factors agree to machine precision.' if max_error < 1e-10
      else 'WARNING: deviations detected.')
